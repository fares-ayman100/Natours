...
var showAlert = exports.showAlert = function showAlert(state, msg) {
  var time = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 5;
  var markup = "<div class=\"alert alert--".concat(state, "\">").concat(msg, "</div>");
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type, " updated successfuly"));
          }
          _context.n = 3;
          break;
        case 2:
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            return _context.a(2, (0, _alerts.showAlert)('error', 'Please fill all fields'));
          case 1:
            if (!(password.length < 8)) {
              _context.n = 2;
              break;
            }
            return _context.a(2, (0, _alerts.showAlert)('error', 'Password must be at least 8 characters'));
          case 2:
            if (!(password !== passwordConfirm)) {
              _context.n = 3;
              break;
            }
            return _context.a(2, (0, _alerts.showAlert)('error', 'Passwords do not match'));
          case 3:
            _context.n = 4;
